...
@pytest.mark.parametrize(
    ...
    [
        (ProductType.PERSON, ['99991', '99992'], 'tests/feed/export_service/data/get_products_by_import_code/successful_found.json'),
        (ProductType.PERSON, ['99991'], 'tests/feed/export_service/data/get_products_by_import_code/successful_not_found.json'),
    ])
