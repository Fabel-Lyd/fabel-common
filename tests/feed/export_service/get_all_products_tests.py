...
def test_get_all_products(export_from: Optional[str], requests_mock) -> None:
    ...
    with freezegun.freeze_time('2024-01-12 20:00:00'):
        actual_result: List[Dict] = feed_export.get_all_products(ProductType.PERSON, datetime.now(pytz.UTC) if export_from else None)
