...
def test_send_payload_successful(mocker) -> None:
    test_data: Dict = read_json_data('tests/feed/import_service/data/send_payload/successful.json')
    ...
    feed_import.send_payload(product_import_list)
