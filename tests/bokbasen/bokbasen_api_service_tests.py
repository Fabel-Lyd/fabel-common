...
def test_send_download_url_request(
    ...
    bokbasen_metadata_api_service = mock_bokbasen_metadata_api_service(BokbasenAudience.DDS)

    response: DownloadResponse = bokbasen_metadata_api_service.send_download_url_request('https://api.dds.boknett.no/content/c4029e6e-a237-4c20-a109-804d398122ab')
